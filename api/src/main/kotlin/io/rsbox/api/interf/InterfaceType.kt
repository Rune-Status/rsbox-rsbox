...
/**
 * Credits to Tomm0017 for his enum.
 *
 * @author Kyle Escobar
 */

enum class InterfaceType(val interfaceId: Int, val fixedChildId: Int, val resizeChildId: Int, val resizeListChildId: Int,
    ...
    companion object {
        val values = enumValues<InterfaceType>()
    }
}